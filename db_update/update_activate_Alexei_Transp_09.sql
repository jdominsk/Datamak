UPDATE data_equil 
SET active = 1,shot_number = '133964', time = 0.501 WHERE transpfile = '133964I20.CDF';

UPDATE data_equil
SET active = 1, shot_number = '133964', time = 0.501 WHERE transpfile = '133964I63.CDF';

UPDATE data_equil
SET active = 1, shot_number = '133964', time = 0.501 WHERE transpfile = '133964I85.CDF';

INSERT INTO data_equil (data_origin_id, folder_path, pfile, pfile_content, gfile, gfile_content, transpfile, shot_number, time, active)
